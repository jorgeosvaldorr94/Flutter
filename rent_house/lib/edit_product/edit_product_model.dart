...
class EditProductModel extends FlutterFlowModel {
  ...
  // State field(s) for yourCurrency widget.
  String? yourCurrencyValue;
  FormFieldController<String>? yourCurrencyValueController;
  // State field(s) for yourRentType widget.
  String? yourRentTypeValue;
  FormFieldController<String>? yourRentTypeValueController;
